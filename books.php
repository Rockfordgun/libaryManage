                                    ...
                                    <tbody>
                                        ...
                                        foreach ($books as $book) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="./includes/deleteBook.php?id=<?php echo $book['book_id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this book?')">Delete</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
