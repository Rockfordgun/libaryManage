    ...
    <div class="row">
      <div class="col-lg-7 bg-secondary loginContainer" style="height: 15rem">
        <div class="buttonContainer d-flex gap-3">
          <h3 class="text-white mt-4 ms-5">Register Here</h3>

        </div>
        <form action="./includes/signup.inc.php" method="post" class="ms-5 mt-4 formContainer form-control bg-secondary">
          ...
          <input class="form-control bg-transparent border-bottom" type="text" placeholder="Enter Your Email Adress" name="email" aria-label="Enter Your Email Adress" style="width: 73%" />
          <div class="input-group mb-3" style="width: 80%">
            <input type="text" class="form-control bg-transparent border-bottom" placeholder="Enter Your Password" aria-label="Enter Your Password" name="pwd" aria-describedby="button-addon2" />
